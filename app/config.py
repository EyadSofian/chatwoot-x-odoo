...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        return cls(
            ...
            max_leads=_env_int("MAX_LEADS", 10),
            max_orders=_env_int("MAX_ORDERS", 10),
            max_invoices=_env_int("MAX_INVOICES", 10),
            max_journal_entries=_env_int("MAX_JOURNAL_ENTRIES", 10),
            max_courses=_env_int("MAX_COURSES", 10),
